...
export declare const isImageValid: () => boolean;
export declare const isMaxFileSizeValid: (fileSize: any, maxFileSize?: any) => boolean;
export declare const isAcceptTypeValid: () => boolean;
export declare const isMaxNumberValid: (totalNumber: any, maxNumber: any, keyUpdate: any) => boolean;
export declare const getErrorValidation: ({ fileList, value, maxNumber, keyUpdate, maxFileSize, resolutionType, resolutionWidth, resolutionHeight, }: {
    fileList: any;
    value: any;
    maxNumber: any;
    keyUpdate: any;
